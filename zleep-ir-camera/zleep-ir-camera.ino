// this code is for the IR thermal sensor used for the Iteration 2 concept ZLEEP of the Slow Technology in Personal Health project by Yinying Miao 
// this caode is based on / retreived from: https://github.com/adafruit/Adafruit_AMG88xx.git
// the credits are shown as the following: 
